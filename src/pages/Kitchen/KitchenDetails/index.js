    ...
    <Layout>
      <div className="category-details-container">
        <div className="details-right">
          <Slider {...settings}>
            {KITCHEN_DATA.KITCHEN_CARD_DATA.map((obj, i) => {
              return (
        ...
        </div>
        {
          !showForm ?
            <div className="details-left">
              ...
              <h1>{t('KITCHEN_DESIGN_DETAILS_DATA.HEADING')}</h1>
                <p>{t('KITCHEN_DESIGN_DETAILS_DATA.SUB_HEADING')}</p>
              </div>
              <div className="stats">
