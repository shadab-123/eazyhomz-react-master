    ...
    <Layout>
      <div className="category-details-container">
        <div className="details-right">
          <Slider {...settings}>
            {KIDS_ROOM_DATA.KIDS_ROOM_CARD_DATA.map((obj, i) => {
              return (
                <div key={`bedroom_slider_${i}`} className="slider-child">
                  <img src={obj.logoPath} alt={`living ${i}`} className="home-img" loading='lazy'/>
                </div>
              );
            })}
          </Slider>
        </div>
        {
          !showForm ?
            <div className="details-left">
              ...
              <h1>{t('KIDS_ROOM_DESIGN_DETAILS_DATA.HEADING')}</h1>
                <p>{t('KIDS_ROOM_DESIGN_DETAILS_DATA.SUB_HEADING')}</p>
              </div>
              <div className="stats">
                  ...
                  return (
                    <div key={`why_us_card_${index}`} className="details-why-us-card-box">
                      ...
                      <Tooltip componentsProps={{
                        ...
                        {/* <p className='text'>{data.text.substr(0, 10)}{data.text.length > 10 ? '...' : ''}</p> */}
...
export default KidsRoomDetails;
