    ...
    <Layout>
      <div className="category-details-container">
        <div className="details-right">
          <Slider {...settings}>
            {BEDROOM_DATA.BEDROOM_CARD_DATA.map((obj, i) => {
              return (
        ...
        </div>
        {
          !showForm ?
            <div className="details-left">
              ...
              <h1>{t('BEDROOM_DESIGN_DETAILS_DATA.HEADING')}</h1>
                <p>{t('BEDROOM_DESIGN_DETAILS_DATA.SUB_HEADING')}</p>
              </div>
              <div className="stats">
