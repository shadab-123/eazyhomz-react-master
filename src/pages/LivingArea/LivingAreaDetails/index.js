...
import './living-area-details.scss';
    ...
    <Layout>
      <div className="category-details-container">
        <div className="details-right">
          <Slider {...settings}>
            {LIVING_AREA_DATA.LIVING_AREA_CARD_DATA.map((obj, i) => {
              return (
        ...
        </div>
        {
          !showForm ?
            <div className="details-left">
              ...
              <h1>{t('LIVING_ROOM_DESIGN_DETAILS_DATA.HEADING')}</h1>
                <p>{t('LIVING_ROOM_DESIGN_DETAILS_DATA.SUB_HEADING')}</p>
              </div>
              <div className="stats">
