    ...
    <Layout>
      <div className="category-details-container">
        <div className="details-right">
          <Slider {...settings}>
            {TV_UNIT_DATA.TV_UNIT_CARD_DATA.map((obj, i) => {
              return (
        ...
        </div>
        {
          !showForm ?
            <div className="details-left">
              ...
              <h1>{t('TV_ROOM_DESIGN_DETAILS_DATA.HEADING')}</h1>
                <p>{t('TV_ROOM_DESIGN_DETAILS_DATA.SUB_HEADING')}</p>
              </div>
              <div className="stats">
