...
import './study-room-details.scss';
    ...
    <Layout>
      <div className="category-details-container">
        <div className="details-right">
          <Slider {...settings}>
            {STUDY_ROOM_DATA.STUDY_ROOM_CARD_DATA.map((obj, i) => {
              return (
        ...
        </div>
        {
          !showForm ?
            <div className="details-left">
              ...
              <h1>{t('STUDY_ROOM_DESIGN_DETAILS_DATA.HEADING')}</h1>
                <p>{t('STUDY_ROOM_DESIGN_DETAILS_DATA.SUB_HEADING')}</p>
              </div>
              <div className="stats">
