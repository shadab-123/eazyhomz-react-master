    ...
    <Layout>
      <div className="category-details-container">
        <div className="details-right">
          <Slider {...settings}>
            {WARDROBE_DATA.WARDROBE_CARD_DATA.map((obj, i) => {
              return (
        ...
        </div>
        {
          !showForm ?
            <div className="details-left">
              ...
              <h1>{t('WARDROBE_DESIGN_DETAILS_DATA.HEADING')}</h1>
                <p>{t('WARDROBE_DESIGN_DETAILS_DATA.SUB_HEADING')}</p>
              </div>
              <div className="stats">
